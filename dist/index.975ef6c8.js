...
var _theMovieDbAPI = require("./js/theMovieDbAPI");
var _filmModal = require("./js/film-modal");
var _requestAPI = require("./js/requestAPI");
var _homePage = require("./js/home-page");
var _myLibrary = require("./js/my-library");
var _footer = require("./js/footer");
var _renderPopularFilmCards = require("./js/renderPopularFilmCards");
// import './js/preloader'
// import './js/preloaderBtn'
var _teamModal = require("./js/teamModal");
var _confetti = require("./js/confetti");
var _buttonUp = require("./js/button-up");

},{"./js/header":"bvS82","./js/theMovieDbAPI":"3Xaoc","./js/film-modal":"bjv1r","./js/requestAPI":"57m5t","./js/home-page":"apvF0","./js/my-library":"9aZ5I","./js/footer":"fXl6u","./js/renderPopularFilmCards":"87q0z","./js/teamModal":"7nouu","./js/confetti":"k9PC7","./js/button-up":"7WO6X"}],"bvS82":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _lodashDebounce = require("lodash.debounce");
var _lodashDebounceDefault = parcelHelpers.interopDefault(_lodashDebounce);
var _theMovieDbAPI = require("./theMovieDbAPI");
var _renderPopularFilmCardsJs = require("./renderPopularFilmCards.js");
const theMovieDbAPI = new (0, _theMovieDbAPI.TheMovieDbAPI)();
const searchFormEl = document.querySelector(".search");
const filmListElem = document.querySelector(".films-list");
const message = document.querySelector(".search__warning");
const DEBOUNCE_DELAY = 500;
(0, _renderPopularFilmCardsJs.renderGenresArr)();
const onSearchFormSubmit = async (event)=>{
    event.preventDefault();
    theMovieDbAPI.query = event.target.value.trim();
    theMovieDbAPI.page = 1;
    if (theMovieDbAPI.query !== "") try {
        const { data: { results: filmArr  } ,  } = await theMovieDbAPI.fetchUniqFilms();
        if (filmArr.length === 0) {
            message.innerHTML = "Search result not successful. Enter the correct movie name.";
            filmListElem.innerHTML = "";
            (0, _renderPopularFilmCardsJs.renderPopularFilmCards)();
            return;
        }
        message.innerHTML = "";
        (0, _renderPopularFilmCardsJs.renderMarkup)(filmArr);
    } catch (err) {
        console.log(err);
    }
    else {
...
searchFormEl && searchFormEl.addEventListener("input", (0, _lodashDebounceDefault.default)(onSearchFormSubmit, DEBOUNCE_DELAY));

},{"lodash.debounce":"3JP5n","./theMovieDbAPI":"3Xaoc","./renderPopularFilmCards.js":"87q0z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
},{}],"3Xaoc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TheMovieDbAPI", ()=>TheMovieDbAPI);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _preloaderBtn = require("./preloaderBtn");
class TheMovieDbAPI {
    ...
    async getPopularFilms(pageNumber) {
        (0, _preloaderBtn.startSpin)();
        this.page = pageNumber;
        const response = await (0, _axiosDefault.default).get(`${TheMovieDbAPI.BASE_URL}/trending/movie/week`, {
            params: {
    ...
    async getGenres() {
        const response = await (0, _axiosDefault.default).get(`${TheMovieDbAPI.BASE_URL}/genre/movie/list`, {
            params: {
                api_key: TheMovieDbAPI.API_KEY
            }
        });
    ...
    async fetchUniqFilms(query) {
        ...
        const response = await (0, _axiosDefault.default).get(`${TheMovieDbAPI.BASE_URL}/search/movie`, searchParams);
        // stopSpin();
        return response;
    ...
    async getMovieInfoById(id) {
        const response = await (0, _axiosDefault.default).get(`${TheMovieDbAPI.BASE_URL}/movie/${id}?`, {
            params: {
                api_key: TheMovieDbAPI.API_KEY
            }
        });
    ...
    async getMovieTrailerById(id) {
        const response = await (0, _axiosDefault.default).get(`${TheMovieDbAPI.BASE_URL}/movie/${id}/videos`, {
            params: {
                api_key: TheMovieDbAPI.API_KEY
            }
        });
...
},{"axios":"jo6P5","./preloaderBtn":"5lDII","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5lDII":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "startSpin", ()=>startSpin);
parcelHelpers.export(exports, "stopSpin", ()=>stopSpin);
function startSpin() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"87q0z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderGenresArr", ()=>renderGenresArr);
...
parcelHelpers.export(exports, "renderPopularFilmCards", ()=>renderPopularFilmCards);
...
function createPaginationIfRequired(totalItems) {
    if (instance) return;
    instance = new (0, _tuiPaginationDefault.default)(container, {
        ...
        template: {
            ...
            moveButton: '<a href="#" class="tui-page-btn-more tui-{{type}}"><span class="tui-ico-{{type}}"></span></a>',
...
async function renderGenresArr(response) {
    try {
        const { data: { genres  } ,  } = await theMovieDbAPI.getGenres(response);
        genresArr = [
            ...genres
        ];
    } catch (err) {}
...
renderGenresArr();
async function renderPopularFilmCards(pageInitialNumber = 1) {
    try {
        const { data: { results: filmArr , total_results  } ,  } = await theMovieDbAPI.getPopularFilms(pageInitialNumber);
        setTimeout(()=>{
...
function renderMarkup(arr) {
    const markup = arr.map((film)=>{
        const { id , title , poster_path , release_date , genre_ids  } = film;
        const newArr = [];
        for (const el of genresArr)if (genre_ids.includes(el.id)) newArr.push(el.name);
        const filmGenres = newArr.join(", ");
        return `<li class="films-list__item poster">
          <a href="#" class="films-list__link" data-movie-id="${id}">
            <div class="films-list__image-wrapper">
              <img
                width="280"
                height="420"
                alt="poster of ${(0, _theMovieDbAPI.TheMovieDbAPI).IMG_URL + poster_path} movie"
                class="films-list__image lazyload"
                data-src="${(0, _theMovieDbAPI.TheMovieDbAPI).IMG_URL + poster_path}"
...
},{"lodash.debounce":"3JP5n","./theMovieDbAPI":"3Xaoc","tui-pagination":"b80gR","./preloaderBtn":"5lDII","lazysizes":"gSx8h","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b80gR":[function(require,module,exports) {
/*!
 * TOAST UI Pagination
 * @version 3.4.1
...
},{}],"bjv1r":[function(require,module,exports) {
var _theMovieDbAPI = require("./theMovieDbAPI");
var _preloaderBtn = require("./preloaderBtn");
var _myLibrary = require("./my-library");
const refs = {
...
async function onFilmCardClick(e) {
    ...
    try {
        ...
        <div class="film-modal-img">
          <img src="${(0, _theMovieDbAPI.TheMovieDbAPI).IMG_URL + poster_path}" alt="poster of ${(0, _theMovieDbAPI.TheMovieDbAPI).IMG_URL + poster_path} movie" />
        </div>
        ...
        if (found) document.querySelector(".film-modal-btn-action.accent").textContent = "remove from watched";
        if (foundQueue) document.querySelector(".film-modal-btn-action.transparent").textContent = "remove from queue";
    } catch (err) {
        console.log(err);
    }
    ...
    const watchTrailerBtn = document.querySelector(".film-modal .film-modal-btn-action.black");
...
function onCloseModalBtn(e) {
    if (e.target !== e.currentTarget && e.currentTarget !== refs.closeModalBtn) return;
...
function onEscKeyBtnPress(e) {
    if (e.code === "Escape" && refs.filmTrailerBackdrop.classList.contains("is-hidden")) {
        refs.filmTrailerWrap.innerHTML = "";
        refs.filmModalWrapEl.innerHTML = "";
        refs.filmModal.classList.add("is-hidden");
        refs.body.classList.remove("no-scroll");
...
async function onAddToWatchedBtnClick(e) {
    e.preventDefault();
    document.querySelector(".film-modal-btn-action.accent").textContent = "remove from watched";
    const movieId = e.target.dataset.movieId;
    const { data  } = await theMovieDbAPI.getMovieInfoById(movieId);
    const watchedFilms = JSON.parse(localStorage.getItem("watched") || "[]");
    let found = watchedFilms.find((obj)=>obj.id === +movieId);
    if (found) {
        watchedFilms.splice(watchedFilms.findIndex((film)=>+film.id === +movieId), 1);
        localStorage.setItem("watched", JSON.stringify(watchedFilms));
        document.querySelector(".film-modal-btn-action.accent").textContent = "add to watched";
    } else {
        watchedFilms.push(data);
        localStorage.setItem("watched", JSON.stringify(watchedFilms));
    }
    if (window.location.pathname === "/my-library.html" && refs.watchedBtn.classList.contains("btn-activ")) (0, _myLibrary.renderMoviesList)("watched");
}
async function onAddToQueueBtnClick(e) {
    e.preventDefault();
    document.querySelector(".film-modal-btn-action.transparent").textContent = "remove from queue";
    const movieId = e.target.dataset.movieId;
    const { data  } = await theMovieDbAPI.getMovieInfoById(movieId);
    ...
    if (found) {
        ...
        document.querySelector(".film-modal-btn-action.transparent").textContent = "add to queue";
    } else {
        watchedFilms.push(data);
        localStorage.setItem("queue", JSON.stringify(watchedFilms));
    }
    if (window.location.pathname === "/my-library.html" && refs.queueBtn.classList.contains("btn-activ")) {
        (0, _myLibrary.renderMoviesList)("queue");
        films.push(data);
...
async function onWatchTrailerBtnClick(e) {
    const movieId = e.target.dataset.movieId;
    try {
        const { data: { results  } ,  } = await theMovieDbAPI.getMovieTrailerById(movieId);
        let key = "";
        for (const el of results)if (el.name === "Official Trailer") key = el.key;
        refs.filmTrailerWrap.innerHTML = `<iframe
	 width="100%"
	 height="100%"
    src="${(0, _theMovieDbAPI.TheMovieDbAPI).YOUTUBE_URL + key}"
    title="YouTube video player"
    frameborder="0"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    allowfullscreen
  ></iframe>`;
        const el1 = document.querySelector("iframe");
        const watchTrailerBtn = document.querySelector(".film-modal .film-modal-btn-action.black");
        if (el1.src.endsWith("/")) {
...
},{"./theMovieDbAPI":"3Xaoc","./preloaderBtn":"5lDII","./my-library":"9aZ5I"}],"9aZ5I":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderMoviesList", ()=>renderMoviesList);
var _theMovieDbAPI = require("./theMovieDbAPI");
var _tuiPagination = require("tui-pagination");
var _tuiPaginationDefault = parcelHelpers.interopDefault(_tuiPagination);
const theMovieDbAPI = new (0, _theMovieDbAPI.TheMovieDbAPI)();
...
function createPaginationIfRequired(totalFilms) {
    ...
    instance.on("afterMove", (event)=>{
        const currentPage = event.page;
        if (watchedBtn.classList.contains("btn-activ")) renderMoviesList("watched", currentPage);
        else if (queueBtn.classList.contains("btn-activ")) renderMoviesList("queue", currentPage);
    });
}
...
function renderMovies(films, genres) {
    const markup = films.map((film)=>{
        ...
        const filmGenresString = genres.filter((genre)=>filmGenres && filmGenres.some((filmGenre)=>filmGenre.id === genre.id)).map((genre)=>genre.name).join(", ");
        return `
          ...
          <a href="#" class="films-list__link" data-movie-id="${id}">
            <div class="films-list__image-wrapper">
              <img
                width="280"
                height="420"
                src="${(0, _theMovieDbAPI.TheMovieDbAPI).IMG_URL + poster_path}"
                alt="poster of ${(0, _theMovieDbAPI.TheMovieDbAPI).IMG_URL + poster_path} movie"
                class="films-list__image"
              />
            </div>
...
},{"./theMovieDbAPI":"3Xaoc","tui-pagination":"b80gR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"57m5t":[function(require,module,exports) {
const API_KEY = "api_key=1deae1a36202e3ac8c29219a3d453e0f";
const BASE_URL = "https://api.themoviedb.org/3";
const API_URL = BASE_URL + "/discover/movie?sort_by=popularity.desc&" + API_KEY;
const IMG_URL = "https://image.tmdb.org/t/p/w500"; // const main = document.getElementById('main')
 // getMovies(API_URL);
...
if (darkMode) switchModeBtn.classList.add("checked");
else switchModeBtn.classList.remove("checked");
...
},{}],"7nouu":[function(require,module,exports) {
...
const modalTeam = _basiclightbox.create(markupTeam);
function openModalTeam(e1) {
    e1.preventDefault();
    modalTeam.show();
...
},{"basiclightbox":"h9e8q"}],"h9e8q":[function(require,module,exports) {
!function(e) {
    module.exports = e();
}(function() {
...
},{}],"k9PC7":[function(require,module,exports) {
...
},{}],"7WO6X":[function(require,module,exports) {
const upBtn = document.querySelector(".page-up-btn");
window.onscroll = function() {
    scrollFunction();
};
function scrollFunction() {
    if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) //  upBtn.style.display = 'flex';
    upBtn.classList.add("shown");
    else upBtn.classList.remove("shown");
}
